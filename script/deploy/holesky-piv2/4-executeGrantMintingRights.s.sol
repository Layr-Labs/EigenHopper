...
contract ExecuteUpgradeAndSetTimestampSubmitter is SetRewardsPermission {
    ...
    function _testFirstPress() internal {
        ...
        // Thu Sep 25 2025 00:00:00 GMT+0000 = 1758758400
        // Thu Oct 02 00:00:00 GMT+0000 = 1729036800
        uint256 sep25th2025 = 1758758400;
        uint256 oct2nd2025 = 1759363200;
        
        // Verify timestamps using TimeUtils
        TimeUtils.assertEq(sep25th2025, "Thu Sep 25 2025 00:00:00 GMT+0000");
        TimeUtils.assertEq(oct2nd2025, "Thu Oct 02 2025 00:00:00 GMT+0000");
        ...
        assertEq(rewardsSubmissions[0].startTimestamp, sep25th2025, "eigen rewards submission start timestamp is not correct");
        assertEq(rewardsSubmissions[0].duration, 1 weeks, "eigen rewards submission duration is not correct");
        assertEq(rewardsSubmissions[1].startTimestamp, sep25th2025, "eth rewards submission start timestamp is not correct");
        ...
        emit ButtonPressed(address(this), oct2nd2025);
