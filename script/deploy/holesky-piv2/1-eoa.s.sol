...
contract Deploy is EOADeployer {
    ...
    address internal constant OLD_TOKEN_HOPPER = 0x1D95fb363ee0f2CbF5ccDebA1a4B2e975dE2A51C;
    ...
    uint256 internal constant EIGEN_STAKERS_WEEKLY_DISTRIBUTION = 1319110.865180572260355029 ether;

    /// @dev The weekly distribution of EIGEN supply for ETH stakers.
    /// Denominated in WAD (18 decimals).
    uint256 internal constant ETH_STAKERS_WEEKLY_DISTRIBUTION = 989333.1488854291952662 ether;
    ...
    uint32 internal constant FIRST_SUBMISSION_START_TIMESTAMP = 1758758400; // Thu Sep 25 2025 00:00:00 GMT+0000
    ...
    /// Denominated in WAD (18 decimals).
    uint256 internal constant STARTING_EIGEN_SUPPLY = 1714844124.734743938461538496 ether;
    ...
    function constructArrays() internal {
        TimeUtils.assertEq(FIRST_SUBMISSION_START_TIMESTAMP, "Thu Sep 25 2025 00:00:00 GMT+0000");
        ...
        string memory toml = vm.readFile("./script/testnet.toml");
